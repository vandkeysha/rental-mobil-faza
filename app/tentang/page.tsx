...
export const metadata: Metadata = {
  title: "Tentang Kami",
  description:
    "PT FAZA Cemerlang Abadi penyedia rental mobil & motor di Cikarang sejak 2022. Terdaftar resmi, armada lengkap, pelayanan profesional.",
};
      ...
      <div className="bg-gradient-to-br from-blue-700 to-blue-600 text-white py-16">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <p className="text-blue-100 text-lg max-w-xl">
            Mitra perjalanan terpercaya di Cikarang sejak 2022 PT FAZA Cemerlang Abadi.
          </p>
        </div>
      </div>
      <TentangClient />
