      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <select
            ...
            id={selectId}
            className={clsx(
              "h-11 w-full rounded-md border pl-3 pr-9 text-base text-ink-900 bg-white",
          ...
          <ChevronDown
            size={18}
            className="pointer-events-none absolute right-5 top-1/2 -translate-y-1/2 text-ink-500"
          />
        </div>
